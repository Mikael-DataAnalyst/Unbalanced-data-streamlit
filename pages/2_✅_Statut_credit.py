...
from Home import best_tresh_scoring1, best_tresh_scoring2, feats, model, data_test
from Home import pouce_rouge, pouce_vert, probs, selection_client
id_client = st.session_state["new_client"]

st.set_page_config(
    page_title="Statut du crédit",
    page_icon="✅")
